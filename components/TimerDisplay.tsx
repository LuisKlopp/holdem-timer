    ...
    <section className="h-60 w-full">
      ...
      >
        <div className="space-y-2 sm:space-y-2.5">
          ...
          <div className="font-dmdisplay text-5xl leading-none tracking-[0.02em] text-amber-200 drop-shadow-[0_0_30px_rgba(245,158,11,0.18)]">
            {formattedTime}
          </div>
          <div className="absolute rounded-full border border-white/10 bg-black/20 px-4 py-1.5 text-xs font-medium text-white/70 backdrop-blur sm:inline-flex sm:text-sm">
